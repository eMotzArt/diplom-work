...
class TestGoalsListByParticipant:
    ROUTE_NAME = 'list goals'
    ROUTE_URL = reverse(ROUTE_NAME)

    def test_get_goal_list_by_participant(self, client, test_user, test_second_user):
        goals_count = 15

        goals = GoalFactory.create_batch(goals_count, user=test_user)
        board = goals[0].category.board
        BoardParticipantFactory(user=test_second_user, board=board, role=BoardParticipant.Role.writer)
    ...
    def test_get_goal_list_by_participant_with_pagination_page_1(self, client, test_user, test_second_user):
        goals_count = 15
        limit = 10
    ...
    def test_get_goal_list_by_participant_with_pagination_page_2(self, client, test_user, test_second_user):
        goals_count = 15
        limit = 10
    ...
    def test_get_goal_list_by_participant_with_ordering_by_priority(self, client, test_user, test_second_user):
    ...
    def test_get_goal_list_by_participant_with_ordering_by_due_date(self, client, test_user, test_second_user):
